...
e=l=2;"horizontal"===x?(u=g.width,A=g.height):(A=g.width,u=g.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))s="auto",l=4;else if(0<=p.indexOf("stacked"))"auto"===s&&(s="inside");else if("bubble"===p||"scatter"===p)s="inside";n=h.point.x-u/2;"inside"!==s?(e=c.y1,f=c.y2,0<C?(q=h.point.y-A-l-b,q<e&&(q="auto"===s?Math.max(h.point.y,e)+l+b:e+l+b,w=q+A>h.point.y)):(q=h.point.y+l+b,q>f-A-l-b&&(q="auto"===s?Math.min(h.point.y,f)-A-l-b:f-A-l-b,w=q<h.point.y))):
(e=Math.max(h.bounds.y1,c.y1),f=Math.min(h.bounds.y2,c.y2),b=0<=p.indexOf("range")||"error"===p?0<C?Math.max(h.bounds.y1,c.y1)+A/2+l:Math.min(h.bounds.y2,c.y2)-A/2-l:(Math.max(h.bounds.y1,c.y1)+Math.min(h.bounds.y2,c.y2))/2,0<C?(q=Math.max(h.point.y,b)-A/2,q<e&&("bubble"===p||"scatter"===p)&&(q=Math.max(h.point.y-A-l,c.y1+l))):(q=Math.min(h.point.y,b)-A/2,q>f-A-l&&("bubble"===p||"scatter"===p)&&(q=Math.min(h.point.y+l,c.y2-A-l))),q=Math.min(q,f-A))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||
0<=p.indexOf("scatter")?(s="auto",e=4):0<=p.indexOf("stacked")?"auto"===s&&(s="inside"):"bubble"===p&&(s="inside"),q=h.point.y-A/2,"inside"!==s?(l=c.x1,f=c.x2,0>C?(n=h.point.x-u-e-b,n<l&&(n="auto"===s?Math.max(h.point.x,l)+e+b:l+e+b,w=n+u>h.point.x)):(n=h.point.x+e+b,n>f-u-e-b&&(n="auto"===s?Math.min(h.point.x,f)-u-e-b:f-u-e-b,w=n<h.point.x))):(l=Math.max(h.bounds.x1,c.x1),Math.min(h.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>C?Math.max(h.bounds.x1,c.x1)+u/2+e:Math.min(h.bounds.x2,c.x2)-
u/2-e:(Math.max(h.bounds.x1,c.x1)+Math.min(h.bounds.x2,c.x2))/2,n=0>C?Math.max(h.point.x,b)-u/2:Math.min(h.point.x,b)-u/2,n=Math.max(n,l));"vertical"===x&&(q+=A);g.x=n;g.y=q;g.render(!0);m&&("inside"!==s&&(0>p.indexOf("bar")&&("error"!==p||!h.axisSwapped)&&h.point.x>c.x1&&h.point.x<c.x2||!w)&&(0>p.indexOf("column")&&("error"!==p||h.axisSwapped)&&h.point.y>c.y1&&h.point.y<c.y2||!w))&&(d.lineWidth=m,d.strokeStyle=k?k:"gray",d.setLineDash&&d.setLineDash(N(v,m)),d.beginPath(),d.moveTo(h.point.x,h.point.y),
0<=p.indexOf("bar")||"error"===p&&h.axisSwapped?d.lineTo(n+(0<h.direction?0:u),q+("horizontal"===x?A:-A)/2):0<=p.indexOf("column")||"error"===p&&!h.axisSwapped?d.lineTo(n+u/2,q+((0<h.direction?A:-A)+("horizontal"===x?A:-A))/2):d.lineTo(n+u/2,q+((q<h.point.y?A:-A)+("horizontal"===x?A:-A))/2),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)h=this._indexLabels[a],
g=ha("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),h.dataSeries.indexLabelBackgroundColor=r(g)?t?"transparent":null:g;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,u=0;u<a.dataSeriesIndexes.length;u++){var A=a.dataSeriesIndexes[u],h=this.data[A];c.lineWidth=
h.lineThickness;var p=h.dataPoints,n="solid";if(c.setLineDash){var q=N(h.nullDataLineDashType,h.lineThickness),n=h.lineDashType,g=N(n,h.lineThickness);c.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=Q(v);b.strokeStyle=v;b.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];c.strokeStyle=v;var m=!0,s=0,x,r;c.beginPath();if(0<p.length){for(var C=!1,s=0;s<p.length;s++)if(x=
p[s].x.getTime?p[s].x.getTime():p[s].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!C)))if("number"!==typeof p[s].y)0<s&&!(h.connectNullData||C||m)&&(c.stroke(),t&&b.stroke()),C=!0;else{x=a.axisX.convertValueToPixel(x);r=a.axisY.convertValueToPixel(p[s].y);var z=h.dataPointIds[s];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:s,x1:x,y1:r};m||C?(!m&&h.connectNullData?(c.setLineDash&&(h.options.nullDataLineDashType||
n===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),n=h.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,r),t&&b.lineTo(x,r)):(c.beginPath(),c.moveTo(x,r),t&&(b.beginPath(),b.moveTo(x,r))),C=m=!1):(c.lineTo(x,r),t&&b.lineTo(x,r),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(x,r),t&&(b.stroke(),b.beginPath(),b.moveTo(x,r))));l={x:x,y:r};s<p.length-1&&(k!==(p[s].lineColor||v)||n!==(p[s].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,
r),k=p[s].lineColor||v,c.strokeStyle=k,c.setLineDash&&(p[s].lineDashType?(n=p[s].lineDashType,c.setLineDash(N(n,h.lineThickness))):(n=h.lineDashType,c.setLineDash(g))));if(0<p[s].markerSize||0<h.markerSize){var B=h.getMarkerProperties(s,x,r,c);f.push(B);z=Q(z);t&&f.push({x:x,y:r,ctx:b,type:B.type,size:B.size,color:z,borderColor:z,borderThickness:B.borderThickness})}(p[s].indexLabel||h.indexLabel||p[s].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:p[s],
dataSeries:h,point:{x:x,y:r},direction:0>p[s].y===a.axisY.reversed?1:-1,color:v})}c.stroke();t&&b.stroke()}}X.drawMarkers(f);t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,
e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,u=0;u<a.dataSeriesIndexes.length;u++){var A=
a.dataSeriesIndexes[u],h=this.data[A];c.lineWidth=h.lineThickness;var p=h.dataPoints,n="solid";if(c.setLineDash){var q=N(h.nullDataLineDashType,h.lineThickness),n=h.lineDashType,g=N(n,h.lineThickness);c.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=Q(v);b.strokeStyle=v;b.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];c.strokeStyle=v;var m=!0,s=0,x,r;c.beginPath();
if(0<p.length){for(var C=!1,s=0;s<p.length;s++)if(x=p[s].getTime?p[s].x.getTime():p[s].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!C)))if("number"!==typeof p[s].y)0<s&&!(h.connectNullData||C||m)&&(c.stroke(),t&&b.stroke()),C=!0;else{var z=r;x=a.axisX.convertValueToPixel(x);r=a.axisY.convertValueToPixel(p[s].y);var B=h.dataPointIds[s];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:s,x1:x,y1:r};m||C?(!m&&h.connectNullData?
(c.setLineDash&&(h.options.nullDataLineDashType||n===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),n=h.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,z),c.lineTo(x,r),t&&(b.lineTo(x,z),b.lineTo(x,r))):(c.beginPath(),c.moveTo(x,r),t&&(b.beginPath(),b.moveTo(x,r))),C=m=!1):(c.lineTo(x,z),t&&b.lineTo(x,z),c.lineTo(x,r),t&&b.lineTo(x,r),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(x,r),t&&(b.stroke(),b.beginPath(),b.moveTo(x,r))));l={x:x,y:r};
s<p.length-1&&(k!==(p[s].lineColor||v)||n!==(p[s].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,r),k=p[s].lineColor||v,c.strokeStyle=k,c.setLineDash&&(p[s].lineDashType?(n=p[s].lineDashType,c.setLineDash(N(n,h.lineThickness))):(n=h.lineDashType,c.setLineDash(g))));if(0<p[s].markerSize||0<h.markerSize)z=h.getMarkerProperties(s,x,r,c),f.push(z),B=Q(B),t&&f.push({x:x,y:r,ctx:b,type:z.type,size:z.size,color:B,borderColor:B,borderThickness:z.borderThickness});(p[s].indexLabel||h.indexLabel||
p[s].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:p[s],dataSeries:h,point:{x:x,y:r},direction:0>p[s].y===a.axisY.reversed?1:-1,color:v})}c.stroke();t&&b.stroke()}}X.drawMarkers(f);t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
...
b.stroke();t&&e.stroke()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],u=0;u<a.dataSeriesIndexes.length;u++){var A=a.dataSeriesIndexes[u],h=this.data[A];b.lineWidth=h.lineThickness;var p=h.dataPoints,n="solid";if(b.setLineDash){var q=N(h.nullDataLineDashType,h.lineThickness),n=h.lineDashType,g=N(n,h.lineThickness);
b.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=Q(v);e.strokeStyle=v;e.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];b.strokeStyle=v;var m=0,s,x,r=[];b.beginPath();if(0<p.length)for(x=!1,m=0;m<p.length;m++)if(s=p[m].getTime?p[m].x.getTime():p[m].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!x)))if("number"!==
typeof p[m].y)0<m&&!x&&(h.connectNullData?b.setLineDash&&(0<r.length&&(h.options.nullDataLineDashType||!p[m-1].lineDashType))&&(r[r.length-1].newLineDashArray=q,n=h.nullDataLineDashType):(d(r),r=[])),x=!0;else{s=a.axisX.convertValueToPixel(s);x=a.axisY.convertValueToPixel(p[m].y);var C=h.dataPointIds[m];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:m,x1:s,y1:x};r[r.length]={x:s,y:x};m<p.length-1&&(k!==(p[m].lineColor||v)||n!==(p[m].lineDashType||h.lineDashType))&&
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.2.4 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
